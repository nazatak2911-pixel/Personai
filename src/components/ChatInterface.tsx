...
export default function ChatInterface({ initialPrompt, contextTitle }: ChatInterfaceProps) {
  ...
  // Send initial context prompt automatically on mount
  useEffect(() => {
    ...
    <div style={{
        ...
        {messages.length === 0 && !isLoading && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', alignItems: 'center', paddingTop: '20px' }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <h3 style={{ color: '#40e0d0', fontSize: '1.2rem', fontWeight: '700', marginBottom: '6px' }}>
                Hello! I'm PERSONAI.
              </h3>
              <p style={{ color: '#b0b0b0', fontSize: '0.9rem', lineHeight: '1.6', maxWidth: '320px' }}>
                Your AI career mentor. Ask me anything about careers, CVs, internships, or your future.
              </p>
            </div>
          ...
          <div key={i} style={{
            ...
            {msg.role === 'assistant' && (
              <div style={{
                ...
                background: 'linear-gradient(135deg, #40e0d0, #2a9d8f)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: '0.75rem', fontWeight: '800', color: '#1a1a1a',
                flexShrink: 0,
              }}>P</div>
            )}
            <div style={{
              ...
              background: msg.role === 'user'
                ? 'linear-gradient(135deg, #40e0d0, #2a9d8f)'
                : 'rgba(40, 40, 40, 0.9)',
      ...
      <div style={{
        ...
        <textarea
          ...
          placeholder="Ask me about your future career..."
          disabled={isLoading}
          rows={1}
          style={{
            flex: 1, padding: '12px 16px', background: 'rgba(40, 40, 40, 0.8)',
            border: '1px solid rgba(64, 224, 208, 0.25)', borderRadius: '16px',
            color: '#ffffff', fontSize: '0.925rem', resize: 'none',
